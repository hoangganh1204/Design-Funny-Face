...
src = src.replace('function imageFill(name, scaleMode) {',
  'function imageFill(name, scaleMode) { global.__curImg = name;');
...
function node(type) {
  return { type, name: '', x: 0, y: 0, width: 0, height: 0, fills: [], strokes: [],
    ...
    set cornerRadiusAll(v) {}, setPluginData() {} };
}
global.figma = {
  ...
  createPage() { const p = { name: '', children: [], appendChild(c) { this.children.push(c); }, setPluginData() {} }; PAGES.push(p); return p; },
