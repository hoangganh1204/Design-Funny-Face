...
const C = {                                   // đo từ res/values/colors.xml (đã resolve)
  primary:  '8b15ca',   // primary_color — brand xanh dương
  ...
  grayF4:   'f4f3f5', grayF5EEE9: 'efeef0', e6e6e5: 'e6e4e7',
...
const R = { card: 16, tile: 20, pill: 30, sm: 10, dialog: 20, r12: 16, r69: 69 };
