...
(function () {
  ...
  function buildSplash(f, opt) {
    ...
    add(f, frame('bg_splash · gradient', 0, 0, SCREEN_W, SCREEN_H, { gradient: ['ffffff', '5915d7'], gradientDir: 'v' }));
    ...
    add(f, textC(STR.adsNote, noteY, { size: 20, weight: 700, font: 'main', color: C.white }));
