...
screen('60 · Result · Skeleton ad (t=0)',
  ...
  (f) => {
    ...
    add(btnSave, text('Save', 158, 0, { size: 16, weight: 700, font: 'main', color: C.white, w: 140, h: 58, align: 'LEFT', valign: 'CENTER' }));
    ...
    add(f, skeleton);
    add(skeleton, rect('divider #ffe4e3e2', 0, 0, SCREEN_W, 1, { fill: 'ffe3e1e5' }));
...
dialog('D61 · Result · AD native_fullscreen_save (back/đóng)',
  ...
  (f) => {
    ...
    add(f, rect('cta bg (bg_white_r16_ads + backgroundTint=gnt_blue #ff4285f4)', 10, ctaY, SCREEN_W - 20, 45, { fill: 'ae37e0', radius: 16 }));
