...
(function () {
  ...
  function buildSplash(f, opt) {
    ...
    const track = frame('progress · track', progX, progY, progW, progH, { fill: '33ffffff', radius: 8 });
    add(f, track);
  ...
  function buildIntroPage(f, pageIndex, opt) {
    ...
    const bg = rect('window_bg', 0, 0, SCREEN_W, SCREEN_H, { gradient: ['5b21b6', 'c4b0ff'], gradientDir: 'v' });
  ...
  function buildLanguagePicker(f, opt) {
    ...
    add(f, text(STR.language, 0, 12, { size: 20, weight: 700, font: 'main', color: C.onMedia, w: SCREEN_W, h: 48, align: 'CENTER', valign: 'CENTER' }));
