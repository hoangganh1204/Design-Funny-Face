...
// v4: BỎ các dòng tiêu đề mở đầu. Trước đây đoạn 0/1 của privacy_policy.html đều là
// "Privacy Policy" (<title> + tiêu đề trong body), và đoạn 0 của term_of_use.html CŨNG là
// "Privacy Policy" — lỗi copy-paste có thật của app gốc. Chồng dưới toolbar vốn đã ghi tên
// màn, chúng thành 2-3 tiêu đề chồng nhau, và màn Terms lại mở đầu bằng chữ "Privacy".
// Product owner yêu cầu bỏ (2026-09-22); app cũng đã sửa asset HTML tương ứng. Phần thân
// văn bản giữ nguyên từng chữ.
const PRIVACY_PARAS = [
  ['H', 'Privacy Policy'],
  ['P', 'This SERVICE is provided by CEM Software. at no cost and is intended for use as is.'],
  ...
  ['P', 'The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at Contacts Backup unless otherwise defined in this Privacy Policy.'],
  ...
  ['H', 'Information that you provide to us'],
  ['P', 'About the face data collecting: We do not collect any face data or user photos. My app provides functionality for users to create a funny sticker from their faces. Users can stitch faces into our drawings to create a fun sticker. Users can then share or use them in iMessage. We do not save this data on the server or send it to any 3rd party. When you first use the face recognition function, You may voluntarily grant us permission to access your camera and album to obtain your facial photo in your mobile device. Only if you confirm the permission, will we gain access to your camera and album?'],
  ['P', 'Cloud Safe is designed to never collect or store any sensitive information. All data stored in Cloud Safe cannot be accessed by us or other third parties because it is always encrypted. Our Terms of Service and Privacy Policy are available below.'],
  ['P', 'Your Secure Data is your property. We claim no rights to it. Only you may add, modify, and delete Secure Data at your discretion. Data Processing Agreement (GDPR)'],
  ['H', 'Log Data'],
...
const TERM_PARAS = [
  ['H', 'Terms of Use'],
  ['P', 'If you continue to use this application , you are agreeing to comply with and be bound by the following terms and conditions of use, which together with our privacy policy govern app relationship with you in relation to this application. If you disagree with any part of these terms and conditions, please do not use our application.'],
  ['P', 'This is a security service and we do not guarantee to give you %100 security. It was designed to protect your conversations and having them backed up on encrypted cloud platform. You accept that we do not guarantee to give you exact results by downloading and upgrading your membership. Keep in mind that this app does not add a passcode to the original applications, only the imported conversations of your choice.'],
  ['H', 'Links To Other Web Sites'],
  ['P', 'We have no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third party web sites or services. You further acknowledge and agree that CEM Software. shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with use of or reliance on any such content, goods or services available on or through any such web sites or services. We strongly advise you to read the terms and conditions and privacy policies of any third party web sites or services that you visit.'],
  ['H', 'Law'],
  ['P', 'These Terms constitute the entire agreement between us regarding our Service, and supersede and replace any prior agreements we might have between us regarding the Service.'],
  ['H', 'Changes'],
  ['P', 'We reserve the right, at our sole discretion, to modify or replace these Terms at any time. Any changes to the Terms will be effective immediately. By continuing to access or use our Service after those revisions become effective, you agree to be bound by the revised terms. If you do not agree to the new terms, please stop using the Service.'],
  ['H', 'Warranty Disclaimer'],
  ['P', 'This is an unofficial product. Any product names, logos, brands, and other trademarks or images featured or referred to within this app are the property of their respective trademark holders. Any of these trademark holders are not affiliated This is app, our products, or with us. They do not sponsor or endorse this app or any of our online products. Neither we nor any third parties provide any warranty or guarantee as to the accuracy, timeliness, performance, completeness or suitability of the information and materials found or offered in this app for any particular purpose. Your use of any information or materials in this app is entirely at your own risk, for which we shall not be liable. It shall be your own responsibility to ensure that any products, services or information available through this app meet your specific requirements.'],
  ['H', 'Free Trial'],
  ['P', 'CEM Software provides a FREE TRIAL period during which you can use all features of the service for a limited period of time. You can manage or cancel the trial subscription through your App Store account.'],
  ['H', 'Payment'],
  ['P', 'CEM Software services are provided through the APP STORE on a paid subscription basis. CEM Software rates for services are listed in the App and on the App Store. CEM Software reserves the right to modify its rates at any time and/or to offer special promotions. CEM Software does not issue refunds for services. CEM Software does not send invoices to its customers. Instead, you have confidential access to your account balance information through the App Store. If you have a billing dispute, you must contact the App Store to seek a remedy.'],
  ['H', 'Contact us'],
  ['P', 'If you have questions regarding this privacy policy, you may email cemsoftware.contact@gmail.com 8th floor, Sannam Building, 78 Duy Tan Street, Dich Vuong Hau Ward, Cau Giay District, Hanoi City, Vietnam'],
];
...
screen('70 · Settings', 'res/layout/fragment_settings.xml + ui/settings/FragmentSettings.java — 1 state duy nhất, không PRO/EU branching (verify: initListener() chỉ gắn 5 click listener, không có initUi()/show()/gone() nào)', (f) => {
  ...
  const backIc = iconDark('ic_back_1', 20, 20, 24, 24);
  if (backIc) add(f, backIc);

  // appCompatTextView3 — style ScreenTitleCommon, constraint top/bottom = btnBack (12..52)
  add(f, text('Settings', 0, 12, { size: 20, weight: 700, font: 'main', color: C.onLight, w: SCREEN_W, h: 40, align: 'CENTER', valign: 'CENTER' }));
  ...
  rows.forEach((r) => {
    const row = frame('Row · ' + r.label, 20, top, 320, ROW_H, { fill: C.paperCard, radius: R.tile, stroke: C.paperLine, strokeW: 1, clip: true });
    add(f, row);
    const ic = icon(r.icon, 20, (ROW_H - 24) / 2, 24, 24);
    if (ic) add(row, ic);
    add(row, text(r.label, 52, 0, { size: r.size, weight: 700, font: 'main', color: C.onLight, w: 320 - 52 - 20, h: ROW_H, valign: 'CENTER', align: 'LEFT' }));
    top += ROW_H + 16;
  });
});
...
screen('71 · CompanyInfo · Privacy Policy', 'res/layout/fragment_company_info.xml + CompanyInfoFragment.initUi() — Type.PRIVACY_POLICY → loadUrl file:///android_asset/privacy_policy.html. Nội dung 16 đoạn đầu trích THẬT từ build/policy-text.json (đoạn 0+1 đều "Privacy Policy" — có thật trong file, không phải lỗi dựng hình).', (f) => {
  add(f, rect('windowBackground', 0, 0, SCREEN_W, SCREEN_H, { fill: C.paper }));
...
function buildCompanyInfoToolbarAndBody(f, title, htmlFile, paragraphs) {
  ...
  const toolbar_ = frame('toolbarLayout', 0, 0, SCREEN_W, 64, { fill: C.paper });
  add(f, toolbar_);
  // v4: đồng bộ với các màn khác — đĩa trắng 40dp ở keyline 16dp. Nền ở đây là giấy
  // kem nên đĩa phải kèm viền, khác với màn lavender chỉ cần bóng (xem backChip).
  backChip(toolbar_, 16, 12, 40, '9a6cff');
  add(toolbar_, text(title, 0, 12, { size: 20, weight: 700, font: 'main', color: C.onLight, w: SCREEN_W, h: 40, align: 'CENTER', valign: 'CENTER' }));

  // wvPrivacyPolicy — WebView, width fill, height match-constraint xuống đáy màn (0dp → 800-64=736)
  const web = frame('wvPrivacyPolicy · WebView', 0, 64, SCREEN_W, SCREEN_H - 64, { fill: C.paper, clip: true });
  add(f, web);
  ...
  // v4: 48 chừa chỗ cho tiêu đề mở đầu và ghi chú canvas; cả hai đã bỏ nên thân bài bắt đầu
  // ngay dưới toolbar, khớp với padding-top của trang HTML thật.
  let cursor = 16;
  // v4: mỗi phần tử là ['H'|'P', nội dung] — trích thẳng từ <strong>/<p> của file HTML
  // thật, nên đoạn văn trọn câu và tiêu đề mục là tiêu đề thật. Bản trước tách theo
  // DÒNG NGUỒN của HTML nên câu bị cắt giữa chừng, và đoán tiêu đề bằng heuristic
  // "ngắn dưới 40 ký tự, không kết thúc bằng dấu chấm" — sai cả hai việc.
  paragraphs.forEach((item) => {
    const isHeading = item[0] === 'H';
    const p = item[1];
    if (isHeading && cursor > 16) cursor += 8;        // hở thêm trước mỗi mục
    const cw = isHeading ? 7.0 : CW;
    const lh = isHeading ? 19 : LH;
    const lines = Math.max(1, Math.ceil((p.length * cw) / PARA_W));
    const h = lines * lh;
    add(web, text(p, 16, cursor, {
      size: isHeading ? 15 : 12, weight: isHeading ? 700 : 400, font: 'main',
      color: C.onLight, w: PARA_W, h: h, lineHeight: lh,
    }));
    cursor += h + (isHeading ? 6 : 10);
  });
...
dialog('D70 · Loading overlay · full-screen dim', 'res/layout/layout_loading.xml, include id=viewLoading trong fragment_preview_with_music.xml — bật khi FragmentPreviewWithMusic.genFile() đang export video. Nền vẽ lại chrome tối giản của chính fragment_preview_with_music.xml (res/layout/fragment_preview_with_music.xml: exoPlayerView fill, btnBack style BackImageButton2, btnAddMusic pill, btnNext style Button.Primary) — đây LUÔN là màn bên dưới overlay, không phải ô đen trơn. exoPlayerView = video kết quả · pathVideoPreview (runtime, do user tạo).', (f) => {
  ...
  const pill70 = frame('btnAddMusic', (SCREEN_W - 120) / 2, 20, 120, 32, { fill: 'cc171716', radius: 40 });
  add(f, pill70);
...
dialog('D71 · Loading card · Setting up', 'res/layout/layout_loading_with_text.xml, include id=viewLoading trong fragment_language_picker.xml — bg root = @color/transparent (KHÔNG có scrim đen, khác D70), card bg_loading_rounded #ffd3d3d3 bo 12dp, text @string/setting_up_language. ⚠ CỜ đã verify độc lập (grep ui/language/FragmentLanguagePicker.java): showLoading() định nghĩa ở dòng 147 nhưng KHÔNG được gọi ở bất kỳ initUi()/click-listener nào đọc được — trùng phát hiện của cụm onboard (screens/onboard.js dòng note màn 12). Đây là STATE LÝ THUYẾT dựng đúng theo layout XML tồn tại thật, KHÔNG phải luồng đang chạy được trong build hiện tại. Nền vẽ chrome fragment_language_picker.xml ĐỦ 7 ngôn ngữ (dùng chung hằng LANGS ở code.js với màn 12/12b/12c, không khai báo lại) (entry point THẬT duy nhất còn lại = qua Settings → action_fragmentSettingsToLanguagePicker(false) → isFromSplash=false → btnBack VISIBLE theo FragmentLanguagePicker.java:181-189).', (f) => {
  ...
  add(f, rect('windowBackground', 0, 0, SCREEN_W, SCREEN_H, { fill: C.paper }));
  const backIc71 = iconDark('ic_back_1', 20, 20, 24, 24); // vào từ Settings → isFromSplash=false → VISIBLE
  if (backIc71) add(f, backIc71);
  add(f, text('Language', 0, 12, { size: 20, weight: 700, font: 'main', color: C.onLight, w: SCREEN_W, h: 40, align: 'CENTER', valign: 'CENTER' }));
  ...
  LANGS.forEach((lang, i) => {
    const y = 60 + 16 + i * 80;
    const row71 = frame('item_language · ' + lang[0], 20, y, 320, 64, { fill: C.paperCard, stroke: C.paperLine, strokeW: 1, radius: R.tile });
    add(f, row71);
    const chk71 = iconDark('ic_check_box_unselected', 20, 20, 24, 24);
    if (chk71) add(row71, chk71);
    add(row71, text(lang[0], 52, 0, { size: 20, weight: 700, font: 'main', color: C.onLight, w: 320 - 72, h: 64, valign: 'CENTER' }));
  });

  // --- overlay layout_loading_with_text.xml (đè lên trên, nền trong suốt — KHÔNG scrim) ---
  const w = 110, h = 94;
  const card = frame('LinearLayout · bg_loading_rounded', (SCREEN_W - w) / 2, (SCREEN_H - h) / 2, w, h, { fill: 'd3d3d3', radius: 12 });
  add(f, card);
  add(card, ellipse('ProgressBar', (w - 40) / 2, 16, 40, 40, { stroke: C.primary, strokeW: 4 }));
  add(card, text('Setting up', 0, 60, { size: 14, font: 'main', color: C.onLight, w: w, align: 'CENTER' }));
});
...
dialog('D72 · AD SLOT · Native full-screen', 'res/layout/dialog_native_full_screen.xml (container_view, fill_parent, bg trắng) LỒNG res/layout/native_fake_full_inter.xml bên trong (NativeAdView thật được nạp vào container_view bởi ll0.I / NativeFullscreenTemplate). Geometry đọc trực tiếp từ native_fake_full_inter.xml: media_view fill 0x0, info-block bg_r8_f4f4f4_ads + backgroundTint #33000000 (ĐÃ verify: tint ghi đè màu solid f4f4f4 → nền THẬT là đen 20% trong suốt, không phải xám) margin L5T50R5 padding V15, badge "AD" (@string/ad) bg_text_view_ads=gnt_red #ffff0000 10sp trắng, primary 16sp bold trắng maxLines1 width70%, body 14sp trắng(gnt_white) maxLines2, cta 45dp bg_white_r16_ads+backgroundTint gnt_blue #4285f4 (→ THẬT là nút xanh, không trắng) text "Install" (@string/install) 20sp trắng width95%. Nội dung quảng cáo cụ thể (icon/tiêu đề/mô tả) là runtime → placeholder trung tính, không bịa thương hiệu. Placement không resolve tĩnh được (remote ad config monet/monet_v2/monet_super/and_ads_test) — CỜ.', (f) => {
  ...
  const cta = frame('cta · bg_white_r16_ads (tint gnt_blue)', (SCREEN_W - ctaW) / 2, SCREEN_H - 20 - 45, ctaW, 45, { fill: '4285f4', radius: 16 });
  add(f, cta);
