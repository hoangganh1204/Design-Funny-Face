...
# LƯU Ý: thiếu thuộc tính ở đây = im lặng mất thông tin. Gặp thật khi dựng Funny Face:
# native_fake_full_inter.xml có android:backgroundTint="#33000000" đè lên
# background="@drawable/bg_r8_f4f4f4_ads" -> nền THẬT là đen 20%, không phải xám f4f4f4;
# và CTA có backgroundTint=@color/gnt_blue -> nền THẬT xanh, không phải trắng.
# Thiếu 'backgroundTint' nên output chỉ thấy `background=` và dựng sai màu hoàn toàn.
KEEP = ['id', 'layout_width', 'layout_height', 'text', 'hint', 'textColor',
        'textSize', 'textStyle', 'background', 'src', 'srcCompat', 'tint',
        'backgroundTint', 'foregroundTint', 'drawableTint', 'iconTint',
        'elevation', 'alpha', 'strokeColor', 'strokeWidth', 'rotation',
